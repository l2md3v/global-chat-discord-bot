...
const globalChannels = [
    "940174280472272936",
    "937612034881769503",
    "942761213127950336" //UNAVAILABLE CHANNEL
...
module.exports = client => {
    ...
    let buttonrow = new Discord.MessageActionRow().addComponents([
        new Discord.MessageButton().setStyle("LINK").setURL("https://discord.gg/phonguoiviet").setLabel("Support Server"),
...
/**
 * @INFO
 * Bot Coded by Tomato#6966 | https://discord.gg/phonguoiviet
 * @INFO
 * Work for Milrato Development | https://github.com/kentjuno7z/global-chat-discord-bot
 * @INFO
